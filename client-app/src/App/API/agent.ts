...
const profiles = {
    ...
    get: (usernam: string) => request.get<Profile>(`/profile/${usernam}`),
    Upload: (file: Blob) => {
    ...
    setMain: (id: string) => request.post<void>(`/Photos/${id}/setmain`, {}),
    deletePhoto: (id: string) => request.delete<void>(`/Photos/${id}`),
} 
